function post_family_tweaks__preset_configs() {
	...
	echo "PRESET_NET_WIFI_SSID='🔧'" >> "${SDCARD}"/root/.not_logged_in_yet
	echo "PRESET_NET_WIFI_KEY='millionmultiply'" >> "${SDCARD}"/root/.not_logged_in_yet
	...
	echo "PRESET_NET_STATIC_IP='10.59.0.11'" >> "${SDCARD}"/root/.not_logged_in_yet
	...
	echo "PRESET_ROOT_PASSWORD=raspberry" >> "${SDCARD}"/root/.not_logged_in_yet

	# Preset username
	echo "PRESET_USER_NAME=pi" >> "${SDCARD}"/root/.not_logged_in_yet

	# Preset user password
	echo "PRESET_USER_PASSWORD=raspberry" >> "${SDCARD}"/root/.not_logged_in_yet

	# Preset user default realname
	echo "PRESET_DEFAULT_REALNAME=FRC5940" >> "${SDCARD}"/root/.not_logged_in_yet
}
